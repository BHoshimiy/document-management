...
@switch($name)
    ...
    @case('admin')
        ...
        @break
    @case('chevron')
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="chev"><polyline points="9 18 15 12 9 6"/></svg>
        @break
    @case('back')
